# Cronograma de Saturn Investments

Cronograma tentativo para el desarrollo del proyecto:

- **Abril 2025**: Planificación y configuración inicial (entorno, TimescaleDB, Flask).
- **Mayo-Junio 2025**: Desarrollo del frontend (Laravel) y análisis básico.
